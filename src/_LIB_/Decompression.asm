...
.GotSize:
		...
		move.b	d0,r_KosM_Mods.w
		andi.l	#$7FF,d3			; Get size of last module in words
		bne.s	.GotLeftover			; Branch if it's non-zero
		subq.b	#1,r_KosM_Mods.w		; Otherwise decrement the number of modules
...
.GotLeftover:
		...
		addq.b	#1,r_KosM_Mods.w		; Store total number of modules
		rts
; ---------------------------------------------------------------------------------------------------------------------------------------------------------
...
.ModulesLeft:
		...
		ori.b	#$80,r_KosM_Mods.w		; And set bit to signify decompression in progress
		rts
; ---------------------------------------------------------------------------------------------------------------------------------------------------------
.DecompressionStarted:
		...
		andi.b	#$7F,r_KosM_Mods.w
		move.l	#$1000/2,d3
		subq.b	#1,r_KosM_Mods.w
